...
protected:
	...
	static __int64 drawImageCallBack(MinecraftUIRenderContext* _this, TextureData* texturePtr, Vec2<float>& imagePos, Vec2<float>& imageDimension, Vec2<float>& UvPos, Vec2<float>& UvSize) {
		...
		static CrystalCham* CCMod = (CrystalCham*)client->moduleMgr->getModule("CrystalCham");
		...
		if (strncmp(texturePtr->ptrToPath->filePath.getText(), prefix, prefixLen) == 0 && HudMod->Hotbar)
		{
			...
			return 0;
		}//D:\MC Project\apk\Microsoft.MinecraftUWP_1.20.5101.0_x64__8wekyb3d8bbwe\data\resource_packs\vanilla\textures\entity\pig
		if (strcmp(texturePtr->ptrToPath->filePath.getText(), "textures/entity/endercrystal/endercrystal") == 0) {
			return 0;
		}
